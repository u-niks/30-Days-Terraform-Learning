...
Once you've verified the Both environments are working correctly, then you can perform the swap:

### Option 1: Using the PowerShell Script (For Windows)
...
### Option 2: Using the Bash Script (For Linux/Ubuntu)

```bash
chmod +x swap-environment.sh
.\swap-environment.sh
```
...
### Option 4: Using AWS Console (Step-by-Step)
