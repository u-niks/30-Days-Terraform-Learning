...
| **Test**    | `test` | 10.1.0.0/16   | Manual approval | **Yes**           |
...
aws s3 mb s3://demo-terraform-state-bucket-00011 --region us-east-1

# Enable versioning for state history
aws s3api put-bucket-versioning \
  --bucket demo-terraform-state-bucket-00011 \
...
terraform {
  backend "s3" {
    bucket       = "demo-terraform-state-bucket-00011"  # Your bucket name
...
# Clone repository
git clone https://github.com/u-niks/30-Days-Terraform-Learning.git
cd aws-devops
