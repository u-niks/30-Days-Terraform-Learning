...
kubectl get svc frontend -n 3tierwebapp-dev
```

## Kustomize Features

The `kustomization.yaml` file demonstrates:
- **Namespace management**: All resources deployed to `3tierwebapp-dev`
...
```bash
# Backend
kubectl logs -f deployment/backend -n 3tierwebapp-dev

# Frontend
kubectl logs -f deployment/frontend -n 3tierwebapp-dev

# Postgres
kubectl logs -f deployment/postgres -n 3tierwebapp-dev
```
