...
This example demonstrates how to use Terraform data sources to reference existing infrastructure in AWS. We will provision an EC2 instance into a pre-existing VPC and subnet.
...
To destroy the resources created in this example:

```bash
# Destroy the instance
cd example/day13/code
terraform destroy
